...
def installed() {
	...
	atomicState.bucketKey = "BQRMP9N9KR7J" //change if needed
	atomicState.bucketName = "st-todd" //change if wanted
	atomicState.accessKey = "l8WD0Y7Z0IJizzM9QdcvQkBBVDbNV8QU" //MUST CHANGE
